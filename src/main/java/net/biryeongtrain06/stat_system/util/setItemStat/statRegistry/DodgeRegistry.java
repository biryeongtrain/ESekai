...
import static net.biryeongtrain06.stat_system.util.setItemStat.ItemStatKeys.ITEM_DODGE_KEY;

public class DodgeRegistry extends StatRegistry{
    @Override
    public NbtCompound setStat(NbtCompound nbt, int level, int rarity) {
        ...
        result.putInt(ITEM_DODGE_KEY, MathHelper.ceil(((Math.random() * maxValue)) + minValue));
        return result;
    }
}
